...
module.exports = {
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*YOUR STATUS HAS BEEN SEEN BY ZONE-MD* 😊",
    ...
    // === MESSAGES & MEDIA ===
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/1yhu8r.jpg",
    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/1yhu8r.jpg",
    LIVE_MSG: process.env.LIVE_MSG || "🚀 *ZONE-MD  is Alive!* 🚀",
    ...
    // === LINKS / SOCIAL ===
    BOT_CHANNEL: process.env.BOT_CHANNEL || "https://whatsapp.com/channel/0029VbAhxYY90x2vgwhXJV3O",
    REPO_LINK: process.env.REPO_LINK || "https://github.com/ZONE-MD",
    YOUTUBE: process.env.YOUTUBE || "https://www.youtube.com/@DRKAMRAN",
    TIKTOK: process.env.TIKTOK || "https://tiktok.com/@DRKAMRAN",
    ...
    COMMUNITY: process.env.COMMUNITY || "https://whatsapp.com/channel/0029VbAhxYY90x2vgwhXJV3O",
